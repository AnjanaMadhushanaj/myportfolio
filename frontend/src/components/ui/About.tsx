...
export default function About() {
  ...
  return (
    <section id="about" className="relative w-full py-16 overflow-hidden z-10">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          ...
          <div className="lg:col-span-2 flex flex-col justify-between bg-[#141021]/80 backdrop-blur-md border border-white/5 rounded-3xl p-8 lg:p-10 shadow-xl hover:border-white/10 hover:bg-[#1a1429]/90 transition-all duration-300 group relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-4 mb-8 text-center md:text-left">
              ...
              <h3 className="text-sm md:text-[1.1rem] lg:text-xl font-semibold text-cyan-100 drop-shadow-[0_0_8px_rgba(6,182,212,0.8)] mt-3 tracking-wide">
              ...
              <p className="text-base md:text-lg text-slate-200 leading-relaxed font-light mt-5 max-w-2xl">
          ...
          <div className="lg:col-span-1 flex flex-col gap-6">
            {/* Box: Location */}
            <div className="flex-1 bg-[#141021]/80 backdrop-blur-md border border-white/5 rounded-3xl p-6 shadow-xl hover:border-white/10 hover:bg-[#1a1429]/90 hover:-translate-y-1 transition-all duration-300 flex flex-col justify-center relative overflow-hidden group">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-4">
                  <MapPin className="w-5 h-5 text-cyan-400 drop-shadow-[0_0_8px_rgba(6,182,212,0.8)]" />
                  <h3 className="text-lg font-bold text-white tracking-wide">Location</h3>
                </div>
                <div className="flex items-center gap-2 text-cyan-300 font-mono text-xs px-2.5 py-1 bg-cyan-500/10 rounded-full border border-cyan-500/20">
                  <Clock className="w-3 h-3" /> {time || "Loading..."}
                </div>
              </div>
              <ul className="space-y-2 pl-9 text-sm text-slate-200">
            ...
            <div className="flex-1 bg-[#141021]/80 backdrop-blur-md border border-white/5 rounded-3xl p-6 shadow-xl hover:border-white/10 hover:bg-[#1a1429]/90 hover:-translate-y-1 transition-all duration-300 flex flex-col justify-center relative overflow-hidden group">
              <div className="flex items-center gap-4 mb-3">
                <Languages className="w-5 h-5 text-fuchsia-400 drop-shadow-[0_0_8px_rgba(217,70,239,0.8)]" />
            ...
            <div className="flex-1 bg-[#141021]/80 backdrop-blur-md border border-white/5 rounded-3xl p-6 shadow-xl hover:border-white/10 hover:bg-[#1a1429]/90 hover:-translate-y-1 transition-all duration-300 flex flex-col justify-center relative overflow-hidden group">
              <div className="flex items-center gap-4 mb-3">
                <MessageSquare className="w-5 h-5 text-green-400 drop-shadow-[0_0_8px_rgba(74,222,128,0.8)]" />
                <h3 className="text-lg font-bold text-white tracking-wide">Soft Skills</h3>
              </div>
              <ul className="space-y-2 pl-9 text-sm text-slate-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          {/* Current Focus */}
          <div className="bg-[#141021]/80 backdrop-blur-md border border-white/5 rounded-3xl p-6 md:p-8 shadow-xl hover:border-white/10 hover:bg-[#1a1429]/90 hover:-translate-y-1 transition-all duration-300 relative overflow-hidden group">
             <div className="absolute top-0 right-0 w-32 h-32 bg-cyan-500/15 rounded-full blur-[50px] pointer-events-none" />
             <Terminal className="w-8 h-8 text-cyan-400 drop-shadow-[0_0_8px_rgba(6,182,212,0.8)] mb-4" />
             <h3 className="text-xl font-bold text-white mb-2 tracking-wide">Current Focus</h3>
          ...
          <div className="bg-[#141021]/80 backdrop-blur-md border border-white/5 rounded-3xl p-6 md:p-8 shadow-xl hover:border-white/10 hover:bg-[#1a1429]/90 hover:-translate-y-1 transition-all duration-300 relative overflow-hidden group">
             ...
             <Layers className="w-8 h-8 text-fuchsia-400 drop-shadow-[0_0_8px_rgba(217,70,239,0.8)] mb-4" />
             <h3 className="text-xl font-bold text-white mb-2 tracking-wide">Favorite Stack</h3>
             <p className="text-sm text-slate-200 leading-relaxed font-light">
          ...
          <div className="bg-[#141021]/80 backdrop-blur-md border border-white/5 rounded-3xl p-6 md:p-8 shadow-xl hover:border-white/10 hover:bg-[#1a1429]/90 hover:-translate-y-1 transition-all duration-300 relative overflow-hidden group">
             ...
             <Award className="w-8 h-8 text-yellow-400 drop-shadow-[0_0_8px_rgba(250,204,21,0.8)] mb-4" />
             <h3 className="text-xl font-bold text-white mb-2 tracking-wide">Achievements</h3>
             <p className="text-sm text-slate-200 leading-relaxed font-light">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          ...
          <div className="bg-[#141021]/80 backdrop-blur-md border border-white/5 rounded-3xl p-6 md:p-8 shadow-xl hover:border-white/10 hover:bg-[#1a1429]/90 hover:-translate-y-1 transition-all duration-300 relative overflow-hidden group">
             ...
             <div className="flex items-start gap-4 relative z-10">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-3 tracking-wide">Certificates</h3>
          ...
          <div className="bg-[#141021]/80 backdrop-blur-md border border-white/5 rounded-3xl p-6 md:p-8 shadow-xl hover:border-white/10 hover:bg-[#1a1429]/90 hover:-translate-y-1 transition-all duration-300 relative overflow-hidden group">
             ...
             <div className="flex items-start gap-4 relative z-10">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-3 tracking-wide">Badges</h3>
                  <div className="flex flex-wrap gap-2 mt-2">
                    <span className="px-3 py-1 bg-[#1a1429] border border-cyan-500/30 rounded-full text-xs text-cyan-300 shadow-[0_0_10px_rgba(6,182,212,0.2)] font-medium tracking-wide">Top Performer</span>
                    <span className="px-3 py-1 bg-[#1a1429] border border-yellow-500/30 rounded-full text-xs text-yellow-300 shadow-[0_0_10px_rgba(234,179,8,0.2)] font-medium tracking-wide">Problem Solver</span>
                  </div>
                </div>
             </div>
          </div>
        ...
        <div className="bg-[#141021]/80 backdrop-blur-md border border-white/5 rounded-3xl p-6 md:p-8 shadow-xl hover:border-white/10 hover:bg-[#1a1429]/90 hover:-translate-y-1 transition-all duration-300 relative overflow-hidden group">
           ...
           <div className="flex items-start gap-5 relative z-10">
              ...
              <div>
                <h3 className="text-xl font-bold text-white mb-2 tracking-wide">Education</h3>
