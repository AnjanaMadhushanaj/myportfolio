      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          {services.map((service, i) => (
            <div key={i} className="w-[80vw] max-w-75 md:w-full md:max-w-none shrink-0 md:shrink snap-center snap-always glass-panel p-6 md:p-8 rounded-3xl group hover:-translate-y-2 transition-all duration-300 relative overflow-hidden flex flex-col justify-start min-h-70 md:min-h-80">
