        ...
        >
          ...
          <motion.div variants={itemVariants} className="w-full relative group">
            ...
            <div className="relative flex flex-col lg:flex-row bg-[#141021]/60 backdrop-blur-md border border-white/10 group-hover:border-white/20 rounded-3xl overflow-hidden shadow-2xl transition-all duration-300">
              ...
              <div className="w-full lg:w-1/2 relative min-h-[300px] lg:min-h-full overflow-hidden bg-[#0A0710]">
              ...
              {/* Right Side: Content */}
              <div className="w-full lg:w-1/2 p-8 lg:p-12 flex flex-col justify-center border-l-0 lg:border-l border-white/5">
                <span className="text-cyan-400 font-mono text-sm font-semibold tracking-wider mb-2 uppercase">Platform Engineering</span>
                <h3 className="text-2xl md:text-4xl font-bold text-white mb-6 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-cyan-300 group-hover:to-fuchsia-300 transition-all duration-300">
                  Automated CI/CD Microservices Pipeline
                </h3>
                <p className="text-slate-300 font-light leading-relaxed mb-8 text-base">
                ...
                <div className="flex flex-wrap gap-3 mb-8">
                  {['Docker', 'AWS', 'GitHub Actions', 'Next.js'].map((tech, i) => (
                    <span key={i} className="px-4 py-1.5 text-xs font-medium text-cyan-100 bg-white/5 border border-white/10 rounded-full backdrop-blur-sm group-hover:border-cyan-500/40 group-hover:shadow-[0_0_10px_rgba(6,182,212,0.3)] transition-all duration-300">
                      {tech}
                    </span>
                  ))}
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            {/* Project 2 */}
            <motion.div variants={itemVariants} className="relative bg-[#141021]/60 backdrop-blur-md border border-white/10 hover:border-fuchsia-500/50 rounded-3xl overflow-hidden shadow-[0_10px_30px_rgba(0,0,0,0.5)] transition-all duration-300 group hover:-translate-y-2">
              <div className="w-full h-56 relative overflow-hidden bg-[#0A0710]">
              ...
              <div className="p-8 border-t border-white/5">
                <span className="text-fuchsia-400 font-mono text-xs font-semibold tracking-wider mb-2 uppercase block">Full-Stack Application</span>
                <h3 className="text-xl font-bold text-white mb-4">Enterprise Task Management System</h3>
            ...
            {/* Project 3 */}
            <motion.div variants={itemVariants} className="relative bg-[#141021]/60 backdrop-blur-md border border-white/10 hover:border-cyan-500/50 rounded-3xl overflow-hidden shadow-[0_10px_30px_rgba(0,0,0,0.5)] transition-all duration-300 group hover:-translate-y-2">
              <div className="w-full h-56 relative overflow-hidden bg-[#0A0710]">
              ...
              <div className="p-8 border-t border-white/5">
                <span className="text-cyan-400 font-mono text-xs font-semibold tracking-wider mb-2 uppercase block">Data Pipeline / ML</span>
                <h3 className="text-xl font-bold text-white mb-4">Real-Time Sensor Data Analytics</h3>
                <p className="text-slate-300 text-sm font-light leading-relaxed mb-6">
