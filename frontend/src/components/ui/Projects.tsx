        ...
        >
              ...
              <div className="w-full lg:w-1/2 p-6 md:p-8 lg:p-12 flex flex-col justify-center border-l-0 lg:border-l border-white/5">
                ...
                <div className="flex flex-wrap gap-2 md:gap-3 mb-5 md:mb-8">
                  {['Docker', 'AWS', 'GitHub Actions', 'Next.js'].map((tech, i) => (
                    <span key={i} className="px-3 md:px-4 py-1 md:py-1.5 text-[10px] md:text-xs font-medium text-cyan-100 bg-white/5 border border-white/10 rounded-full backdrop-blur-sm group-hover:border-cyan-500/40 transition-all duration-300">
                      {tech}
                    </span>
                  ))}
                </div>
                <div className="flex items-center gap-5 mt-auto">
                  <a href="#" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-white hover:scale-110 transition-all duration-300"><Github className="w-6 h-6" /></a>
                  <a href="#" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-cyan-400 hover:scale-110 transition-all duration-300"><ExternalLink className="w-6 h-6" /></a>
                </div>
              </div>
          ...
          {/* Projects 2 & 3: Full-Stack Roots */}
            ...
            <motion.div variants={itemVariants} className="w-[85vw] sm:w-100 md:max-w-none md:w-auto shrink-0 snap-center relative bg-[#141021]/95 md:bg-[#141021]/60 backdrop-blur-md border border-white/25 md:border-white/10 hover:border-fuchsia-500/50 rounded-3xl overflow-hidden shadow-[0_10px_30px_rgba(0,0,0,0.5)] transition-all duration-300 group hover:-translate-y-2 md:h-auto flex flex-col">
              ...
              <div className="p-6 md:p-8 border-t border-white/5 flex flex-col">
                ...
                <p className="text-slate-300 text-xs md:text-sm font-light leading-snug md:leading-relaxed mb-4 md:mb-6">
            ...
            <motion.div variants={itemVariants} className="w-[85vw] sm:w-100 md:max-w-none md:w-auto shrink-0 snap-center relative bg-[#141021]/95 md:bg-[#141021]/60 backdrop-blur-md border border-white/25 md:border-white/10 hover:border-cyan-500/50 rounded-3xl overflow-hidden shadow-[0_10px_30px_rgba(0,0,0,0.5)] transition-all duration-300 group hover:-translate-y-2 md:h-auto flex flex-col">
              ...
              <div className="p-6 md:p-8 border-t border-white/5 grow flex flex-col">
                ...
                <p className="text-slate-300 text-xs md:text-sm font-light leading-snug md:leading-relaxed mb-4 md:mb-6 grow">
