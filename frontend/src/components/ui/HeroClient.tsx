        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 w-full grid md:grid-cols-2 gap-10 md:gap-12 items-center">
          ...
          <div className="flex flex-col space-y-6 text-center md:text-left">
            ...
            <div className="hidden md:flex flex-wrap items-center gap-6 pt-6 relative z-20">
              <a href={data.hireLink} className="px-8 py-3.5 rounded-xl bg-[#c026d3] text-white font-bold transition-all duration-300 hover:scale-105 hover:bg-[#d946ef] shadow-[0_0_20px_rgba(217,70,239,0.3)] hover:shadow-[0_0_30px_rgba(217,70,239,0.6)] active:scale-95">
                Hire Me
              </a>
              <a href={data.worksLink} className="px-8 py-3.5 rounded-xl glass border-2 border-white/20 text-white font-bold transition-all duration-300 hover:scale-105 hover:bg-white/10 hover:border-white/50 active:scale-95 shadow-[inset_0_0_20px_rgba(255,255,255,0.05)] hover:shadow-[0_0_20px_rgba(255,255,255,0.2)]">
                Works
              </a>
            </div>
          </div>
          ...
          <div className="flex md:hidden flex-wrap items-center justify-center gap-4 mt-2 mb-4 w-full relative z-20">
            <a href={data.hireLink} className="px-6 py-3 rounded-xl bg-[#c026d3] text-white font-bold transition-all duration-300 hover:scale-105 hover:bg-[#d946ef] active:scale-95 text-sm sm:text-base">
              Hire Me
            </a>
            <a href={data.worksLink} className="px-6 py-3 rounded-xl glass border-2 border-white/20 text-white font-bold transition-all duration-300 hover:scale-105 hover:bg-white/10 active:scale-95 text-sm sm:text-base shadow-[inset_0_0_20px_rgba(255,255,255,0.05)]">
              Works
            </a>
          </div>
        </div>
